...
//  CryptoCurrencyViewTrue
//
//  Created by Владислав Лукашевич on 30.05.22.
//
...
final class CryptoTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if let cell = tableView.dequeueReusableCell(withIdentifier: CryptoTableViewCell.identifier, for: indexPath) as? CryptoTableViewCell {
